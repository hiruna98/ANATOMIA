...
public class Cutter : MonoBehaviour
{
    ...
    public static void Cut(GameObject originalGameObject, Vector3 contactPoint, Vector3 cutNormal, Transform rootTransform)
    {
        ...
        cutobject.GetComponent<MeshFilter>().mesh = finishedLeftMesh;
        var collider = cutobject.AddComponent<MeshCollider>();
		...
		{
            mats[i] = cutobject.GetComponent<MeshRenderer>().material;
        }
        ...
        // right.transform.SetParent(rootTransform);
        // cutobject.transform.SetParent(rootTransform);
